...
describe JungleBeat do
  ...
  it 'appends the beats to the list'
    jb = JungleBeat.new
    jb.append('deep doo ditt')
    expect(jb.list.to_string).to eq('deep do ditt')
  end  

  it 'returns the number of beats in the list'
    jb = JungleBeat.new
    jb.append('deep do ditt')
  ...
  it 'plays the beats with the say command'
    jb = JungleBeat.new
    jb.append('deep doo ditt')
